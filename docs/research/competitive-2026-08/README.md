...
| 文件 | 角色 |
|------|------|
| **[25-tool-surface-meta-proactive-audit.md](./25-tool-surface-meta-proactive-audit.md)** | **工具面 / Meta / 奏折 SSOT v0.8.37**：T-S1/T-S2/T-S3/S10 **已落地**；日用 P0 无；奏折/git/browser 仍 P1 |
| **[24-post-0.8.36-harness-re-audit.md](./24-post-0.8.36-harness-re-audit.md)** | **Harness SSOT v0.8.36 取证**：对话跨 run、表拆箱、rewind fork、S8/S7 随 **0.8.37** 发；S10 随后落地 |
...
| 24 | [24-post-0.8.36-harness-re-audit.md](./24-post-0.8.36-harness-re-audit.md) | **0.8.36** | **Harness SSOT**：上文/表/rewind；S8/S7 随 0.8.37 发；S10 随后落地 |
| 25 | [25-tool-surface-meta-proactive-audit.md](./25-tool-surface-meta-proactive-audit.md) | **0.8.37** | 工具面：T-S1/T-S2/T-S3/S10 已落地；奏折仍 P1；MCP 已有勿重造 |
