...
var baseCatalogRows = []catalogRow{
	...
	catalog(MsgHelpCommandSkills, "  /skills                skill inventory (invoke with /name when user-invocable)", "  /skills                技能清单（user-invocable 可用 /name 调用）", "  /skills                スキル一覧（user-invocable は /name で実行）", "  /skills                기술 목록(user-invocable은 /name 호출)", "  /skills                inventario de skills (/name si invocable)", "  /skills                inventaire des skills (/name si invocable)"),
	catalog(MsgHelpCommandHooks, "  /hooks                 hook inventory and health", "  /hooks                 Hook 清单与健康状态", "  /hooks                 フック一覧とヘルス", "  /hooks                 훅 목록 및 상태", "  /hooks                 inventario y salud de hooks", "  /hooks                 inventaire et santé des hooks"),
	catalog(MsgHelpCommandExtensions, "  /extensions            extension inventory; /extension enable|disable <name>", "  /extensions            扩展清单；/extension enable|disable <name>", "  /extensions            拡張一覧；/extension enable|disable <name>", "  /extensions            확장 목록; /extension enable|disable <name>", "  /extensions            inventario; /extension enable|disable <name>", "  /extensions            inventaire ; /extension enable|disable <name>"),
