...
var builtinCommandRegistry = []commandDescriptor{
	...
	{Name: "approval-mode", Usage: "/approval-mode [ask|always-approve|dont-ask]", Description: "set product HITL mode (Grok-style ask/dontAsk/bypass)", Source: "builtin", Validate: anyArgs},
