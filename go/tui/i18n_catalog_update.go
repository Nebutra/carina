...
var updateCatalogRows = []catalogRow{
	...
	catalog(MsgTaskStatusInterrupted, "interrupted · recovery pending", "已中断 · 等待恢复", "中断 · 復旧待ち", "중단됨 · 복구 대기", "interrumpida · recuperación pendiente", "interrompue · reprise en attente"),
