...
Carina is an alpha local-first harness for coding agents. It contains real
...
The current source line targets Carina Harness `0.10.x` (latest published GitHub Release: `v0.10.0`); the TypeScript and
