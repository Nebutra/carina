...
pub enum Action {
    ...
    SelectConversationImport(usize),
    ToggleConversationImportAll,
    CycleConversationImportSource,
    ToggleConversationImportScope,
    ReviewConversationImport,
    ConfirmConversationImport,
    CancelConversationImport,
    RetryConversationImport,
    SelectConversationImportResult(usize),
    OpenConversationImportResult,
    BeginRenameSession,
