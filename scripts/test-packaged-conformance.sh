...
stage="${stages[0]}"
for binary in carina carina-daemon carina-worker carina-tui carina-kernel-service carina-scan carina-grep carina-diff carina-run carina-pty carina-patch-native; do
