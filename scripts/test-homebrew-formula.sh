...
grep -Fq 'version "0.6.1"' "$formula"
grep -Fq 'https://github.com/Nebutra/carina/releases/download/v0.6.1/' "$formula"
grep -Fq 'if Hardware::CPU.arm?' "$formula"
grep -Fq 'carina_0.6.1_darwin_arm64.tar.gz' "$formula"
grep -Fq 'carina_0.6.1_darwin_amd64.tar.gz' "$formula"
