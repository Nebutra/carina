...
for binary in carina carina-ui carina-daemon carina-worker carina-kernel-service carina-diff carina-grep carina-patch-native carina-pty carina-run carina-scan headroom; do
