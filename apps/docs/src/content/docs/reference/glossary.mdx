...
One of the eighteen gated action types (FileRead, CommandExec, PatchApply, MemoryWrite, SubagentSpawn, SwarmSpawn, …). Every meaningful effect maps to a capability check.
