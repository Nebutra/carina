...
class ClientTest(unittest.TestCase):
    ...
    def test_typed_parity_and_stream(self) -> None:
        ...
        with daemon_server(handler) as path:
            ...
            self.assertEqual(compatible_runtime_version, "0.9.1")
    ...
    def test_high_level_thread_run(self) -> None:
        ...
        def handler(request: dict[str, Any], conn: socket.socket) -> None:
            result: Any = {}
            if request["method"] == "runtime.initialize": result = {"runtime_version":"0.9.1","protocol_version":"1.2.0","projection_version":"1.0.0","capabilities":{"tool_call_lifecycle":True,"event_schema_version":"0.3.0"}}
